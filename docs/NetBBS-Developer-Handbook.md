...
| `[managed_dns]` | `service_url` points the node at a different managed netbbs.org service; unset means the shipped address in `netbbs.managed_dns.state.DEFAULT_SERVICE_URL` |
